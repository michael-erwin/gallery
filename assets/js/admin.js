...
admin_app.library =
{
    ...
    init: function() {
        ...
        this.objects.display_buttons = this.self.find('[data-id="display_buttons"] button');
        ...
        this.objects.display_buttons.unbind().on('click',this.switchDisplay.bind(this));
    ...
    render: function(){
            ...
            if(this.data.type == "images") {
                if(this.data.display == 'thumb') {
                    for(var image in entries) {
                        ...
                        html +=
                        '<div class="media-entry thumb-box col-lg-2 col-md-3 col-sm-4 col-xs-6" data-id="'+image.id+'" data-category_id="'+image.category_id+'" data-title="'+image.title+'">'+
                            '<div class="thumb" >'+
                    ...
                    html += '<ul class="list-box">'
                        for(var image in entries) {
                            ...
                            html +=
                                '<li class="media-entry list clearfix" data-id="'+image.id+'" data-category_id="'+image.category_id+'" data-title="'+image.title+'">'+
                ...
                if(this.data.display == 'thumb') {
                    for(var video in entries) {
                        ...
                        html +=
                        '<div class="media-entry thumb-box col-lg-2 col-md-3 col-sm-4 col-xs-6" data-id="'+video.id+'" data-category_id="'+video.category_id+'" data-title="'+video.title+'">'+
                            '<div class="thumb" >'+
                    ...
                    html += '<ul class="list-box">'
                        for(var video in entries) {
                            ...
                            html +=
                                '<li class="media-entry list clearfix" data-id="'+video.id+'" data-category_id="'+video.category_id+'" data-title="'+video.title+'">'+
                                    '<div class="image" style="background-image:url('+thumb+')">'+
        ...
        this.objects.display_buttons.removeClass('active');
        ...
        this.objects.content_box.find('a.image-preview').fullsizable({
            detach_id: 'main_header',
            clickBehaviour: 'next'
        });
