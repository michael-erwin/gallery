...
class Item extends CI_Controller
{
    ...
    private function displayHTML($info)
    {
        ...
        $media = [
            ...
            'image_url' => base_url()."images/preview/lg/".preg_replace('/\s/','-', $info['title'])."-".$info['uid']
        ];
        ...
        $data['media_item_details'] = $this->load->view('common/v_image_item_page_frontend',$media,true);
